...
| NEXT_PUBLIC_NETWORK_DEBUG_RPC_URL | `string` | Chain RPC server url for debug methods like debug_traceTransaction | - | `https://debug.rpc.quai.network` | `https://debug.rpc.example.com` |
